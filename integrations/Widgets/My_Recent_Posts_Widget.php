...
namespace Codeneon_Plugin_Suites\Integrations\Widgets;
...
class My_Recent_Posts_Widget extends \WPH_Widget {
	...
	public function __construct() {
		$args = array(
			'label'       => \__( 'My Recent Posts Example', CPS_TEXTDOMAIN ),
			'description' => \__( 'My Recent Posts Widget Description', CPS_TEXTDOMAIN ),
			'slug'        => 'recent-posts',
		...
		$args[ 'fields' ] = array(
			...
			array(
				// Field name/label
				'name'     => \__( 'Title', CPS_TEXTDOMAIN ),
				// Field description
				'desc'     => \__( 'Enter the widget title.', CPS_TEXTDOMAIN ),
				// Field id
				'id'       => 'title',
				...
				'class'    => 'widefat',
				// Default value
				'std'      => \__( 'Recent Posts', CPS_TEXTDOMAIN ),
				/**
			...
			// Taxonomy Field
			array(
				'name'  => \__( 'Taxonomy', CPS_TEXTDOMAIN ),
				'desc'  => \__( 'Set the taxonomy.', CPS_TEXTDOMAIN ),
				'id'    => 'taxonomy',
				'type'  => 'taxonomy',
				'class' => 'widefat',
			),
			// Taxonomy Field
			array(
				'name'     => \__( 'Taxonomy terms', CPS_TEXTDOMAIN ),
				'desc'     => \__( 'Set the taxonomy terms.', CPS_TEXTDOMAIN ),
				'id'       => 'taxonomyterm',
				'type'     => 'taxonomyterm',
				'taxonomy' => 'category',
				'class'    => 'widefat',
			...
			// Pages Field
			array(
				'name'  => \__( 'Pages', CPS_TEXTDOMAIN ),
				'desc'  => \__( 'Set the page.', CPS_TEXTDOMAIN ),
				'id'    => 'pages',
				'type'  => 'pages',
				'class' => 'widefat',
			),
			// Post type Field
			array(
				'name'     => \__( 'Post type', CPS_TEXTDOMAIN ),
				'desc'     => \__( 'Set the post type.', CPS_TEXTDOMAIN ),
				'id'       => 'posttype',
				'type'     => 'posttype',
				'posttype' => 'post',
				'class'    => 'widefat',
			...
			// Amount Field
			array(
				'name'     => \__( 'Amount', CPS_TEXTDOMAIN ),
				'desc'     => \__( 'Select how many posts to show.', CPS_TEXTDOMAIN ),
				'id'       => 'amount',
				'type'     => 'select',
				// Selectbox fields
				'fields'   => array(
					array(
						'name'  => \__( '1 Post', CPS_TEXTDOMAIN ),
						'value' => '1',
					),
					array(
						'name'  => \__( '2 Posts', CPS_TEXTDOMAIN ),
						'value' => '2',
					),
					array(
						'name'  => \__( '3 Posts', CPS_TEXTDOMAIN ),
						'value' => '3',
					),
			...
			array(
				'name'   => \__( 'Output as list', CPS_TEXTDOMAIN ),
				'desc'   => \__( 'Wraps posts with the <li> tag.', CPS_TEXTDOMAIN ),
				'id'     => 'list',
				'type'   => 'checkbox',
				// Checked by default:
				'std'    => 1, // 0 or 1
	...
	public function initialize() {
		...
		'widgets_init',
		static function() {
			\register_widget( 'Codeneon_Plugin_Suites\Integrations\Widgets\My_Recent_Posts_Widget' );
		}
		);
	}
